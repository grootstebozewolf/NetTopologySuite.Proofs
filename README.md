...
`make host` builds the 83 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 647 registered modules —
556 registered under `theories/` and 91 registered under
