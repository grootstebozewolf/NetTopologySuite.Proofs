...
`make host` builds the 85 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 649 registered modules —
558 registered under `theories/` and 91 registered under
