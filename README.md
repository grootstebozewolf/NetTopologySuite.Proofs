...
`make host` builds the 86 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 651 registered modules —
560 registered under `theories/` and 91 registered under
