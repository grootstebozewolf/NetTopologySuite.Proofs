...
`make host` builds the 94 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 654 registered modules —
563 registered under `theories/` and 91 registered under
