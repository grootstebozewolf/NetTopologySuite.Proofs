...
`make host` builds the 77 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 625 registered modules —
534 registered under `theories/` and 91 registered under
