...
`make host` builds the 84 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 648 registered modules —
557 registered under `theories/` and 91 registered under
