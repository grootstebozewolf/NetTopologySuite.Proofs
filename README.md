...
`make host` builds the 95 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 655 registered modules —
564 registered under `theories/` and 91 registered under
