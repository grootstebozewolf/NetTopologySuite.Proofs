...
The ceiling has named exceptions rather than silent ones: 38 files under
...
Stdlib-only layer. The full corpus is 639 registered modules —
548 registered under `theories/` and 91 registered under
