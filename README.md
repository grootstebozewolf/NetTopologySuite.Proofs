...
The ceiling has named exceptions rather than silent ones: 35 files under
...
Stdlib-only layer. The full corpus is 627 registered modules —
536 registered under `theories/` and 91 registered under
