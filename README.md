...
`make host` builds the 92 modules in `_CoqProject`, the foundational
Stdlib-only layer. The full corpus is 652 registered modules —
561 registered under `theories/` and 91 registered under
