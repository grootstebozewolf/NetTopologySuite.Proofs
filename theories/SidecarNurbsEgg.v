(* ============================================================================
   ...
   demoted-chord fixture. Host MkNurbs is scaffolding;
   NURBS×NURBS first cook stays QEX in NurbsCookMkNurbs.v
   (NurbsNotChordDemote). Prefer SidecarNurbs* for the
   ...
   Host MkNurbs scaffolding + NURBS×NURBS QEX live in
   ...
   Host MkNurbs is scaffolding. NURBS×NURBS stays QEX
   (NurbsNotChordDemote). Tags stay Decline. Do not remint
   ...
   First cook stays chord–chord / circ / clothoid. Host CircGamma
...
(* MkOutOfScope tag (packaging). Host Egg has MkNurbs scaffolding.            *)
(* -------------------------------------------------------------------------- *)
...
Lemma sidecar_nurbs_not_chord_demote_missing :
  ~ sidecar_nurbs_ctor_inhabits NurbsNotChordDemote.
Proof.
  intro H. exact H.
Qed.
...
Lemma mknurbs_pair_not_interpolant :
  forall n1 n2,
    ~ interpolant_pair (MkNurbs n1) (MkNurbs n2).
Proof.
  intros n1 n2 H. exact H.
Qed.

Lemma mknurbs_pair_hit_false :
  forall p ti tj,
...
Lemma try_cook_hit_mknurbs_none :
...
(* WITNESS {"claimId":"0007-nurbs-egg","topic":"overlay","lemma":"ticket_0007_nurbs_not_first_cook_qed_or_qex","title":"Sidecar NURBS expands first_cook_scope to NURBS times NURBS and inhabits I_ok Hit (QED) or NURBS times NURBS stays QEX with named MkNurbs / Hit-arm / NurbsNotChordDemote gaps (QEX); discharged QEX; host first-cook letter 0007-nurbs-first-cook; tags stay Decline","file":"theories/SidecarNurbsEgg.v","witness":"0007-nurbs-egg","board":"ADR-0007"} *)
...
Proof.
  ...
  split; [exact sidecar_nurbs_not_chord_demote_missing|].
...
Print Assumptions sidecar_nurbs_not_chord_demote_missing.
Print Assumptions mknurbs_pair_hit_false.
Print Assumptions try_cook_hit_mknurbs_none.
