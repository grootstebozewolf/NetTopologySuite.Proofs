(* ============================================================================
   ...
   Old pin retired as ceiling, cited here. Tags stay MkOutOfScope
   Decline. No MkNurbs. No on_nurbs. No host IHit.

   RIGHT would name an obstruction and keep the old QEX. Not this
   letter: the only inhabit path that would have been a silent
   NURBS=MkCirc / NURBS=MkChord demote is refused (#729). Scope
   membership does not need that path.
...
(* WITNESS {"claimId":"0007-nurbs-nurbs-first-cook","topic":"overlay","lemma":"ticket_0007_nurbs_nurbs_first_cook_qed_or_qex","title":"NURBS times NURBS first_cook_scope inhabited and old nurbs_nurbs_not_first_scope ceiling retired (QED) or named obstruction keeps the old QEX (QEX); discharged QED; tags Decline; no MkNurbs / on_nurbs / silent MkCirc / silent MkChord; #767 stays circ times chord I; LoopDischarged stays QEX","file":"theories/NurbsNurbsFirstCook.v","witness":"0007-nurbs-nurbs-first-cook","board":"ADR-0007"} *)
