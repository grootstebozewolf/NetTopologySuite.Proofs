...
From NTS.Proofs Require Import Distance Overlay OverlayGraph Vec Azimuth
                               Dart DartNextSpec DartAngularOrder DartFace
                               FaceChain FaceOrbitSep ExtractFaces
                               EdgeConnectivity VertexGeneralPosition.
...
(*     forall E d, fan_ok on darts_of E -> In d (darts_of E) -> proper d ->   *)
(*     same_face (darts_of E) d (twin d) ->                                    *)
