...
(* -------------------------------------------------------------------------- *)
(* §5  The remaining deep rung (documented, not proved here).                  *)
(*                                                                            *)
(* The headline that closes the extract_rings_valid bridge is                  *)
(*                                                                            *)
(*   edge_2_connected (result_edges op g)                                      *)
(*     -> FaceOrbitSep.twins_in_different_faces (result_darts op g)            *)
(*                                                                            *)
