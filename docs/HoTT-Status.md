...
| Hobby (4.1/4.3 biarc/residual) | GREEN skeleton (started on feature/hott-rgr-hobby-noding) | Archived `theories-flocq/HobbyTheorem_b64.v` etc. (b64 proofs for biarc/residual monotonicity). | Re-express Hobby lemmas using transport via Shewchuk orient_equiv; start NTS_Hobby model. |
