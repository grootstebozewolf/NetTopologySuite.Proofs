...
| B — rectangle (unconditional) | `hole_inside_outer`, rectangular outer | ~1 slice | **ready** — chain all Qed; concrete witness exists (`HoleInsideOuterExample.v`), needs generalising to all rectangles |
