...
the container `_CoqProject.full` builds the entire corpus (630 registered modules — 539 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 630 registered modules — 539 registered under `theories/`,
...
This builds the 78 modules in `_CoqProject`, the foundational
Stdlib-only layer.
