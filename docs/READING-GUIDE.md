...
The host lane builds the 77 modules in `_CoqProject`, the
foundational `theories/` layer;
the container `_CoqProject.full` builds the entire corpus (625 registered modules — 534 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 625 registered modules — 534 registered under `theories/`,
  91 registered under `theories-flocq/` (77 of them modules in `_CoqProject`
...
This builds the 77 modules in `_CoqProject`, the foundational
Stdlib-only layer.
