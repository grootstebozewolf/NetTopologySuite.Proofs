...
the container `_CoqProject.full` builds the entire corpus (640 registered modules — 549 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 640 registered modules — 549 registered under `theories/`,
