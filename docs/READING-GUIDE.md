...
the container `_CoqProject.full` builds the entire corpus (647 registered modules — 556 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 647 registered modules — 556 registered under `theories/`,
