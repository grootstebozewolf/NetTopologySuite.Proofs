...
The host lane builds the 86 modules in `_CoqProject`, the
foundational `theories/` layer;
the container `_CoqProject.full` builds the entire corpus (651 registered modules — 560 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 651 registered modules — 560 registered under `theories/`,
  91 registered under `theories-flocq/` (86 of them modules in `_CoqProject`
...
This builds the 86 modules in `_CoqProject`, the foundational
Stdlib-only layer.
