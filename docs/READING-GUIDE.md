...
The host lane builds the 79 modules in `_CoqProject`, the
foundational `theories/` layer;
the container `_CoqProject.full` builds the entire corpus (639 registered modules — 548 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 639 registered modules — 548 registered under `theories/`,
  91 registered under `theories-flocq/` (79 of them modules in `_CoqProject`
...
This builds the 79 modules in `_CoqProject`, the foundational
Stdlib-only layer.
