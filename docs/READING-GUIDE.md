...
the container `_CoqProject.full` builds the entire corpus (650 registered modules — 559 registered under `theories/`, 91 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 7,600 Qed-closed
  theorems across 650 registered modules — 559 registered under `theories/`,
