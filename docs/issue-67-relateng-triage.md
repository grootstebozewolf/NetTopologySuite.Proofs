...
- triangle touch capstone (S15l cont): helpers + EE cell + prepared tri cache + deferred registry entries added. Strict II / BB / satisfy_pointset capstone + regime decision still open (registered). 
...
| S15l+ | Rect + Triangle helpers + EE cell + prepared tri cache + deferred registry **added**. Full capstone (II/BB/satisfy) + regime still DEFERRED (registered). See milestone doc. | S15k |
